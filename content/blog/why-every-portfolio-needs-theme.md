...
> [!NOTE]
> Ensure contrast ratios are accessible (WCAG compliant) and that content loads cleanly on mobile viewports. If the 3D book is too heavy for mobile, defer its loading or simplify it.
